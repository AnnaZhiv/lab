...
![интерфейс приложения](https://github.com/Annazhiv/lab/raw/master/lab01/lab01/1(1).jpg)
2.Настроила необходимые параметры.
![первичная настройка](https://github.com/Annazhiv/lab/raw/master/lab01/lab01/2(1).jpg)
3.Зарегестрировалась и запустила машину.
![работает](https://github.com/Annazhiv/lab/raw/master/lab01/lab01/3(1).png)
## Вывод
